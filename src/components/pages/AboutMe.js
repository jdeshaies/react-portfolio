  ...
  return (
    <div>
      ...
      <p>
        ...
        Feel free to checkout some of my projects in the "Portfolio" tab, reach out to me in the "Contact" tab, or take a look at my experience in the "Resume" tab. You can also connect with me
